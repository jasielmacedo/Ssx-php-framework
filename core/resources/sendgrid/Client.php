...
require RESOURCEPATH . 'sendgrid/resources/api_keys.php';
require RESOURCEPATH . 'sendgrid/resources/asm_groups.php';
require RESOURCEPATH . 'sendgrid/resources/asm_suppressions.php';
require RESOURCEPATH . 'sendgrid/resources/global_stats.php';
