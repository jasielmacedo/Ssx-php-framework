...
class HtmlSanitizer
{
    ...
    {
        $HtmlSanitizer_stripJavascriptURL = 'javascript:[^"]+';

        $str = preg_replace("/$HtmlSanitizer_stripJavascriptURL/i"
            , '__forbidden__'
            , $str );
    ...
    {
        $HtmlSanitizer_URL = 'href="([^"]+)"';

        return preg_replace_callback("/$HtmlSanitizer_URL/i"
    ...
    private function removeDOMEvents( $str )
    {
        ...
        $HtmlSanitizer_stripAttrib = '(onclick|ondblclick|onmousedown|'
            . 'onmouseup|onmouseover|onmousemove|onmouseout|onkeypress|onkeydown|'
            . 'onkeyup|onfocus|onblur|onabort|onerror|onload)'
            ;

        $str = stripslashes( preg_replace("/$HtmlSanitizer_stripAttrib/i"
            , 'forbidden'
            , $str ) );
    ...
    private function removeStyle( $str )
    {
        ...
        $HtmlSanitizer_stripAttrib = '(style)'
            ;
