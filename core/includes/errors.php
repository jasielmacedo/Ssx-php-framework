 ...
 */
  ...
  define("ERROR_COMMON_01", "Erro ao cadastrar. Tente novamente mais Tarde.");
  define("ERROR_COMMOM_02", "Tempo limite foi atingido. Tente enviar os dados novamente.");
  define("ERROR_COMMOM_03", "A URL informada n&atilde;o foi encontrada. Se voc&ecirc; tem certeza de que ela existe, entre em contato o administrador.");