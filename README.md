...
I've used and evolved this framework since 2010 but now I've moved forward to a new language
...
1.  Copy all files one step back from your domain folder.
	If your domain runs on **www/** or **http/** paste all files on the same parent folder of these folders not inside them. 

2.  To edit database credencials you'll need to execute **files/hash.php** on apache/nginx to generate encrypted database information.
...
4. 	Create one environment variable called **APPLICATION_ENV** with value **development**.
	Set to **production** to change for production environment
...
6.  In your apache/nginx, set your domain to run on **www/** folder
